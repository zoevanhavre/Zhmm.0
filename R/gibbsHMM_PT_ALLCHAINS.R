...
gibbsHMM_PT_ALLCHAINS<-function(YZ, M=2000, K=5, mu0=0, var0=100, alphaMin=0.5, J=10){
...
## PT move
          ...
          Z[[Chain2]][m,]<-.z1
            ...
            #output
      return(list("Means"=MU, "Trans"=Q, "States"=Z, "q0"=q0, "YZ"=YZ, "MAP"=MAP, "trackPT"=TrackParallelTemp))
      }
